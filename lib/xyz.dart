...
//
// class FirestoreColumnData extends StatefulWidget {
//
//   @override
//   State<FirestoreColumnData> createState() => _FirestoreColumnDataState();
// }
//
// class _FirestoreColumnDataState extends State<FirestoreColumnData> {
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Firestore Column Data'),
//       ),
//       body: SingleChildScrollView(
//         child: FutureBuilder<QuerySnapshot>(
//           future: FirebaseFirestore.instance.collection('providerServiceDetails').get(),
...
//                 //     crossAxisAlignment: CrossAxisAlignment.start,
//                 //     children: [
//                 //       Text('Field 1: ${data['category']}'),
//                 //       Text('Field 2: ${data['providerEmail']}'),
//                 //       Text('Field 3: ${data['providerId']}'),
//                 //       Divider(),
//                 //     ],
//                 //   ),
//                 // );
