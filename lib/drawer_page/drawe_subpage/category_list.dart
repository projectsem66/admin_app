...
class _categorylistState extends State<categorylist> {
  ...
  //       content: Text(
  //     "you have successfully deleted a items",
  //     style: TextStyle(color: AppColors.Colorq),
  //   )));
  // }
  ...
  Future<void> _delete(String documentId) async {
    try {
      ...
      DocumentReference documentReference = FirebaseFirestore.instance.collection('category').doc(documentId);
